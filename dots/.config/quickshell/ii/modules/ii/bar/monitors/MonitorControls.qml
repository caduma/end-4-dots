...
Scope {
    ...
    Loader {
        id: monitorControlsLoader
        active: GlobalStates.monitorControlsOpen
        onActiveChanged: {
            if (!monitorControlsLoader.active && root.realPlayers.length === 0) {
                GlobalStates.monitorControlsOpen = false;
            }
        }
